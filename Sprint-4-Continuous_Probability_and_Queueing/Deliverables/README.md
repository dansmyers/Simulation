...
P(X > 3000) = e^(-1/2000 * 3000)
= e^(-3/2)

For both bulbs:
= (e^(-3/2))^2
The answer is abour .04978
```
...
S = .005 seconds per disk access
Each job has 2 disk accesses which means that the time for each 
job is 0.01.

Let's put this into utilization:
u = λ * S 
= 120 * .01
u = 1.2
