"""
Christian Huber
CMS 380, Fall 2020 / Challenge Projects / Bayesian Spam Filtering
This script uses a naïve Bayesian classifier to classify spam
text from a given dataset (spam.csv from Kaggle.com, pre-processed)
"""
